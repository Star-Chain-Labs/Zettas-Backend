...
router
  .route("/unblock-user-with-amount")
...
router
  .route("/unblock-login-user/:id")
  .post(isAdminAuthenticated, unblockUserLogin);
router
  .route("/withdrawal-reports")
  .get(isAdminAuthenticated, getAllWithdrawalHistory);
...
router
  ...
  .get(isAdminAuthenticated, adminTopUpHistory);
router.route("/income-toggle-status").post(isAdminAuthenticated, incomeBlock);
router.route("/create-promo-code").post(isAdminAuthenticated, createPromoCode);
router
  .route("/get-all-stake-history")
  .get(isAdminAuthenticated, getAllStakeInvestmentHistory);
router
  .route("/get-all-withdrawal-settings")
  .get(isAdminAuthenticated, getWithdrawalSettings);
router
  .route("/update-withdrawal-setting-wallet")
  .post(isAdminAuthenticated, upsertWithdrawalSetting);
router
